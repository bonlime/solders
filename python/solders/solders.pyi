...
class TokenAccount:
    ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "TokenAccount": ...
    @staticmethod
...
class RpcSimulateBundleAccountsConfig:
    def __init__(
        self, addresses: Sequence[str], encoding: Optional[UiAccountEncoding] = None
    ): ...
    @property
    ...
    def __repr__(self) -> str: ...
    def __richcmp__(
        self, other: "RpcSimulateBundleAccountsConfig", op: int
    ) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
...
class RpcSimulateBundleConfig:
    def __init__(
        self,
        pre_execution_accounts_configs: Sequence[
            Optional[RpcSimulateBundleAccountsConfig]
        ],
        post_execution_accounts_configs: Sequence[
            Optional[RpcSimulateBundleAccountsConfig]
        ],
    ...
    @property
    def pre_execution_accounts_configs(
        self,
    ) -> List[Optional[RpcSimulateBundleAccountsConfig]]: ...
    @property
    def post_execution_accounts_configs(
        self,
    ) -> List[Optional[RpcSimulateBundleAccountsConfig]]: ...
    @property
    ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __richcmp__(self, other: "RpcSimulateBundleConfig", op: int) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "RpcSimulateBundleConfig": ...
...
class RpcProgramAccountsV2Config:
    def __init__(
        self,
        account_config: RpcAccountInfoConfig,
        filters: Optional[Sequence[Union[int, Memcmp]]] = None,
        with_context: Optional[bool] = None,
        sort_results: Optional[bool] = None,
    ...
    def with_context(self) -> Optional[bool]: ...
    @property
    def sort_results(self) -> Optional[bool]: ...
    @property
    def limit(self) -> Optional[int]: ...
    @property
    def pagination_key(self) -> Optional[str]: ...
    @property
    def changed_since_slot(self) -> Optional[int]: ...
    def __bytes__(self) -> bytes: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __richcmp__(self, other: "RpcProgramAccountsV2Config", op: int) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "RpcProgramAccountsV2Config": ...
    @staticmethod
    def default() -> "RpcProgramAccountsV2Config": ...
...
class RpcTransactionsForAddressSortOrder:
    Asc: "RpcTransactionsForAddressSortOrder"
    Desc: "RpcTransactionsForAddressSortOrder"
    def __int__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...

class RpcTransactionsForAddressStatus:
    Succeeded: "RpcTransactionsForAddressStatus"
    Failed: "RpcTransactionsForAddressStatus"
    Any: "RpcTransactionsForAddressStatus"
    def __int__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...

class RpcTransactionsForAddressTokenAccounts:
    None_: "RpcTransactionsForAddressTokenAccounts"
    BalanceChanged: "RpcTransactionsForAddressTokenAccounts"
    All: "RpcTransactionsForAddressTokenAccounts"
    def __int__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...

class RpcTransactionsForAddressSlotRange:
    def __init__(
        self,
    ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __richcmp__(self, other: "RpcTransactionsForAddressSlotRange", op: int) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "RpcTransactionsForAddressSlotRange": ...
    @staticmethod
    def default() -> "RpcTransactionsForAddressSlotRange": ...

class RpcTransactionsForAddressBlockTimeRange:
    def __init__(
        self,
        gte: Optional[int] = None,
        gt: Optional[int] = None,
    ...
    def lt(self) -> Optional[int]: ...
    @property
    def eq(self) -> Optional[int]: ...
    def __bytes__(self) -> bytes: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __richcmp__(self, other: "RpcTransactionsForAddressBlockTimeRange", op: int) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "RpcTransactionsForAddressBlockTimeRange": ...
    @staticmethod
    def default() -> "RpcTransactionsForAddressBlockTimeRange": ...

class RpcTransactionsForAddressSignatureRange:
    def __init__(
        self,
        gte: Optional[Signature] = None,
        gt: Optional[Signature] = None,
        lte: Optional[Signature] = None,
        lt: Optional[Signature] = None,
    ): ...
    @property
    def gte(self) -> Optional[Signature]: ...
    @property
    def gt(self) -> Optional[Signature]: ...
    @property
    def lte(self) -> Optional[Signature]: ...
    @property
    def lt(self) -> Optional[Signature]: ...
    def __bytes__(self) -> bytes: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __richcmp__(
        self, other: "RpcTransactionsForAddressSignatureRange", op: int
    ) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "RpcTransactionsForAddressSignatureRange": ...
    @staticmethod
    def default() -> "RpcTransactionsForAddressSignatureRange": ...

class RpcTransactionsForAddressFilters:
    def __init__(
        self,
        slot: Optional[RpcTransactionsForAddressSlotRange] = None,
        block_time: Optional[RpcTransactionsForAddressBlockTimeRange] = None,
        signature: Optional[RpcTransactionsForAddressSignatureRange] = None,
        status: Optional[RpcTransactionsForAddressStatus] = None,
        token_accounts: Optional[RpcTransactionsForAddressTokenAccounts] = None,
    ): ...
    @property
    def slot(self) -> Optional[RpcTransactionsForAddressSlotRange]: ...
    @property
    def block_time(self) -> Optional[RpcTransactionsForAddressBlockTimeRange]: ...
    @property
    def signature(self) -> Optional[RpcTransactionsForAddressSignatureRange]: ...
    @property
    def status(self) -> Optional[RpcTransactionsForAddressStatus]: ...
    @property
    def token_accounts(self) -> Optional[RpcTransactionsForAddressTokenAccounts]: ...
    def __bytes__(self) -> bytes: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __richcmp__(self, other: "RpcTransactionsForAddressFilters", op: int) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "RpcTransactionsForAddressFilters": ...
    @staticmethod
    def default() -> "RpcTransactionsForAddressFilters": ...

class RpcTransactionsForAddressConfig:
    def __init__(
        self,
        transaction_details: Optional[TransactionDetails] = None,
        sort_order: Optional[RpcTransactionsForAddressSortOrder] = None,
        commitment: Optional[CommitmentLevel] = None,
        min_context_slot: Optional[int] = None,
        limit: Optional[int] = None,
        ...
        encoding: Optional[UiTransactionEncoding] = None,
        max_supported_transaction_version: Optional[int] = None,
        filters: Optional[RpcTransactionsForAddressFilters] = None,
    ): ...
    @property
    def transaction_details(self) -> Optional[TransactionDetails]: ...
    @property
    def sort_order(self) -> Optional[RpcTransactionsForAddressSortOrder]: ...
    @property
    def commitment(self) -> Optional[CommitmentLevel]: ...
    @property
    def min_context_slot(self) -> Optional[int]: ...
    ...
    def max_supported_transaction_version(self) -> Optional[int]: ...
    @property
    def filters(self) -> Optional[RpcTransactionsForAddressFilters]: ...
    def __bytes__(self) -> bytes: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __richcmp__(self, other: "RpcTransactionsForAddressConfig", op: int) -> bool: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> "RpcTransactionsForAddressConfig": ...
    @staticmethod
    def default() -> "RpcTransactionsForAddressConfig": ...
...
class RpcProgramAccountsV2Result:
    accounts: List[Union[RpcKeyedAccountJsonParsed, RpcKeyedAccount]]
    pagination_key: Optional[str]
    total_results: Optional[int]
    context: Optional[RpcResponseContext]
    def __init__(
        self,
        accounts: Sequence[Union[RpcKeyedAccountJsonParsed, RpcKeyedAccount]],
        pagination_key: Optional[str] = None,
        total_results: Optional[int] = None,
        context: Optional[RpcResponseContext] = None,
    ) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcProgramAccountsV2Result: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcProgramAccountsV2Result: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class GetProgramAccountsV2Resp:
    def __init__(self, value: RpcProgramAccountsV2Result) -> None: ...
    @property
    def value(self) -> RpcProgramAccountsV2Result: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> Resp[GetProgramAccountsV2Resp]: ...
    @staticmethod
    def from_bytes(data: bytes) -> GetProgramAccountsV2Resp: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RpcTransactionsForAddressFullData:
    def __init__(
        self,
        slot: int,
        transaction: EncodedVersionedTransaction,
        transaction_index: Optional[int] = None,
        meta: Optional[UiTransactionStatusMeta] = None,
        block_time: Optional[int] = None,
    ) -> None: ...
    @property
    def slot(self) -> int: ...
    ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcTransactionsForAddressFullData: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcTransactionsForAddressFullData: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
RpcTransactionsForAddressData = Union[
    RpcConfirmedTransactionStatusWithSignature,
    RpcTransactionsForAddressFullData,
]

class RpcTransactionsForAddressResult:
    def __init__(
        self,
        data: Sequence[RpcTransactionsForAddressData],
        pagination_token: Optional[str] = None,
    ) -> None: ...
    @property
    def data(self) -> List[RpcTransactionsForAddressData]: ...
    @property
    def pagination_token(self) -> Optional[str]: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcTransactionsForAddressResult: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcTransactionsForAddressResult: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class GetTransactionsForAddressResp:
    def __init__(self, value: RpcTransactionsForAddressResult) -> None: ...
    @property
    def value(self) -> RpcTransactionsForAddressResult: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> Resp[GetTransactionsForAddressResp]: ...
    @staticmethod
    def from_bytes(data: bytes) -> GetTransactionsForAddressResp: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RpcSimulateBundleTransactionFailureDetails:
    def __init__(
        self,
        tx_signature: Optional[str] = None,
        raw_tx_signature_bytes: Optional[bytes] = None,
        message: Optional[str] = None,
        instruction_index: Optional[int] = None,
        custom_error_hex: Optional[str] = None,
        custom_error_code: Optional[int] = None,
    ) -> None: ...
    @property
    def tx_signature(self) -> Optional[str]: ...
    @property
    def raw_tx_signature_bytes(self) -> Optional[bytes]: ...
    @property
    def message(self) -> Optional[str]: ...
    @property
    def instruction_index(self) -> Optional[int]: ...
    @property
    def custom_error_hex(self) -> Optional[str]: ...
    @property
    def custom_error_code(self) -> Optional[int]: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcSimulateBundleTransactionFailureDetails: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcSimulateBundleTransactionFailureDetails: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RpcSimulateBundleSummaryFailure:
    def __init__(self, error: Any, tx_signature: Optional[str] = None) -> None: ...
    @property
    def error(self) -> Any: ...
    @property
    def tx_signature(self) -> Optional[str]: ...
    def try_parse_transaction_failure(
        self,
    ) -> Optional[RpcSimulateBundleTransactionFailureDetails]: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcSimulateBundleSummaryFailure: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcSimulateBundleSummaryFailure: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RpcSimulateBundleSummaryFailed:
    failed: RpcSimulateBundleSummaryFailure
    def __init__(self, failed: RpcSimulateBundleSummaryFailure) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcSimulateBundleSummaryFailed: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcSimulateBundleSummaryFailed: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
RpcSimulateBundleSummary = Union[str, RpcSimulateBundleSummaryFailed]

class RpcSimulateBundleTransactionResult:
    err: Optional[TransactionErrorType]
    logs: Optional[List[str]]
    pre_execution_accounts: Optional[List[Optional[Union[Account, AccountJSON]]]]
    post_execution_accounts: Optional[List[Optional[Union[Account, AccountJSON]]]]
    units_consumed: Optional[int]
    return_data: Optional[TransactionReturnData]
    def __init__(
        self,
        err: Optional[TransactionErrorType] = None,
        logs: Optional[Sequence[str]] = None,
        pre_execution_accounts: Optional[Sequence[Optional[Union[Account, AccountJSON]]]] = None,
        post_execution_accounts: Optional[Sequence[Optional[Union[Account, AccountJSON]]]] = None,
        units_consumed: Optional[int] = None,
        return_data: Optional[TransactionReturnData] = None,
    ) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcSimulateBundleTransactionResult: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcSimulateBundleTransactionResult: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RpcSimulateBundleResult:
    summary: RpcSimulateBundleSummary
    transaction_results: List[RpcSimulateBundleTransactionResult]
    def __init__(
        self,
        summary: RpcSimulateBundleSummary,
        transaction_results: Sequence[RpcSimulateBundleTransactionResult],
    ) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcSimulateBundleResult: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcSimulateBundleResult: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class SimulateBundleResp:
    context: RpcResponseContext
    value: RpcSimulateBundleResult
    def __init__(self, value: RpcSimulateBundleResult) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> Resp[SimulateBundleResp]: ...
    @staticmethod
    def from_bytes(data: bytes) -> SimulateBundleResp: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class RpcTransactionNotification:
    def __init__(
        self,
        slot: int,
        signature: Signature,
    ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> RpcTransactionNotification: ...
    @staticmethod
    def from_bytes(data: bytes) -> RpcTransactionNotification: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class TransactionNotification:
    result: RpcTransactionNotification
    subscription: int
    def __init__(self, result: RpcTransactionNotification, subscription: int) -> None: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_json(raw: str) -> TransactionNotification: ...
    @staticmethod
    def from_bytes(data: bytes) -> TransactionNotification: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class GetProgramAccountsV2:
    def __init__(
        self,
        program: Pubkey,
        config: Optional[RpcProgramAccountsV2Config] = None,
        id: Optional[int] = None,
    ): ...
    @property
    def program(self) -> Pubkey: ...
    @property
    def config(self) -> Optional[RpcProgramAccountsV2Config]: ...
    @property
    def id(self) -> int: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_bytes(data: bytes) -> "GetProgramAccountsV2": ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class GetTransactionsForAddress:
    def __init__(
        self,
        address: Pubkey,
        config: Optional[RpcTransactionsForAddressConfig] = None,
        id: Optional[int] = None,
    ): ...
    @property
    def address(self) -> Pubkey: ...
    @property
    def config(self) -> Optional[RpcTransactionsForAddressConfig]: ...
    @property
    def id(self) -> int: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_bytes(data: bytes) -> "GetTransactionsForAddress": ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
...
class SimulateBundle:
    def __init__(
        self,
        encoded_transactions: Sequence[str],
        config: Optional[RpcSimulateBundleConfig] = None,
        id: Optional[int] = None,
    ): ...
    @property
    def encoded_transactions(self) -> List[str]: ...
    @property
    def config(self) -> Optional[RpcSimulateBundleConfig]: ...
    @property
    def id(self) -> int: ...
    def to_json(self) -> str: ...
    @staticmethod
    def from_bytes(data: bytes) -> "SimulateBundle": ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __eq__(self, o: object) -> bool: ...
    def __bytes__(self) -> bytes: ...
